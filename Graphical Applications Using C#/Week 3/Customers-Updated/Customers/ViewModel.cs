...
namespace Customers
{
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        private const string ServerUrl = "https://adventureworkservice20230429155327.azurewebsites.net";
        ...
        public ViewModel()
        {
            ...
            this.NextCustomer = new Command(this.Next,
                () => this.CanBrowse && this.customers != null && this.customers.Count > 1 && !this.IsAtEnd);
            this.PreviousCustomer = new Command(this.Previous,
                () => this.CanBrowse && this.customers != null && this.customers.Count > 0 && !this.IsAtStart);
            this.FirstCustomer = new Command(this.First,
                () => this.CanBrowse && this.customers != null && this.customers.Count > 0 && !this.IsAtStart);
            this.LastCustomer = new Command(this.Last,
                () => this.CanBrowse && this.customers != null && this.customers.Count > 0 && !this.IsAtEnd);
            this.MoreCustomers = new Command(async () => await this.More(),
                () => this.CanBrowse && this.client != null);
